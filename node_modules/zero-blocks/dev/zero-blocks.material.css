...
.ig-form-group label {
  ...
  transition: transform 0.3s ease-in-out, scale 0.3s cubic-bezier(0.25, 0.8, 0.25, 1), color 0.3s ease-in-out; }
...
.ig-control__cbx:indeterminate ~ .ig-control__label:after {
  width: 20px;
  height: 20px;
  background-color: #0375be;
  border: 2px solid #0375be; }
...
.ig-control__switch:checked ~ .ig-control__label {
  background-color: rgba(3, 117, 190, 0.5); }
...
.ig-button, .ig-button--flat, .ig-button--raised, .ig-button--gradient, .ig-button--fab {
  position: relative;
  display: inline-block;
  min-width: 5.5em;
  padding: 0.5em 1em;
  ...
  -webkit-tap-highlight-color: transparent;
  overflow: hidden; }
  .ig-button:hover, .ig-button--flat:hover, .ig-button--raised:hover, .ig-button--gradient:hover, .ig-button--fab:hover {
...
.ig-button--gradient {
  color: #fff;
  background: linear-gradient(to bottom right, #e41c77, #731963);
  box-shadow: 0 4px 10px -2px rgba(107, 23, 92, 0.8); }
  .ig-button--gradient:hover {
    background: linear-gradient(to bottom right, #ce196b, #5e1451);
    box-shadow: 0 4px 10px -2px rgba(107, 23, 92, 0.8); }
  .ig-button--gradient:focus, .ig-button--gradient:active {
    background: linear-gradient(to bottom right, #ce196b, #5e1451);
    box-shadow: 0 6px 12px -1px rgba(94, 20, 81, 0.75); }
...
.ig-button--icon {
  ...
  .ig-button--icon:hover {
    transition: all 0.2s ease-out 0s;
    background: rgba(240, 240, 240, 0.5); }
  .ig-button--icon:focus, .ig-button--icon:active {
...
/*# sourceMappingURL=zero-blocks.material.css.map */
